...
describe('render()', () => {
  it('falls back to error when metadata requirements missing', () => {
    const node = render(
      JSON.stringify({ type: 'card', data: {} }),
      undefined,
      undefined,
      {
        card: {
    ...
    expect(container.textContent).toContain('Error: Missing required data for card');
  });
